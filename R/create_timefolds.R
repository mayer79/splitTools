...
#'
#' The data is first partitioned into k+1 sequential blocks B_1 to B_{k+1}.
...
#' (if \code{type = "moving"}) or {B_1, B_2} (if \code{type = "extending"})
#' as in-sample, and B_3 as out-of-sample data etc. Finally, the kth fold uses
#' {B_1, ..., B_k} ("extending") or B_k ("moving") as in-sample data, and B_{k+1}
#' as out-of-sample data. This makes sure that out-of-sample data always
